...
| Task | Plan file | Depends on | Status | Commit | Note |
|---|---|---|---|---|---|
| DB1.1 | 03-knowledge/01-config-keys-and-dependency.md | — (early-dispatch allowed: file set disjoint from every DA task, README §2; needs npm registry access, PD-07) | - | | |
...
M-B gate: Status ` - ` · Date ` ` · Note ` ` · H1: Status ` - ` · Note ` `
